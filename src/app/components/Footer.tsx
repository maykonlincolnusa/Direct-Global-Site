        ...
        <div className="surface-panel rounded-[2.5rem] px-6 py-8 lg:px-10 lg:py-10">
          <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr_0.8fr_1fr]">
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="footer-link">{t("industries.real_estate")}</div>
                <div className="footer-link">{t("industries.construction")}</div>
                <div className="footer-link">{t("industries.logistics")}</div>
                <div className="footer-link">{t("industries.health")}</div>
              </div>
            </div>

            <div className="space-y-5">
              <h4 className="text-[11px] font-semibold uppercase tracking-[0.24em] text-white/[0.45]">
                Contato
              </h4>
